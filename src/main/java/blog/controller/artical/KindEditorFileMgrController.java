...
import blog.comparator.NameComparator;
import blog.comparator.SizeComparator;
import blog.comparator.TypeComparator;
 ...
 *
 */
@WebServlet(urlPatterns={URLConstants.ARTICAL_FILE_MANAGE},
	initParams={@WebInitParam(name="attachmentPath",value=SysConstants.PATH_ATTACHMENT)})
public class KindEditorFileMgrController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String rootPath = req.getServletContext().getRealPath("/") + "attached/";
		//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
		String rootUrl  = req.getContextPath() + "/attached/";
		//图片扩展名
